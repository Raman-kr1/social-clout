...
const FilterSidebar = ({ onOpenChange }: FilterSidebarProps) => {
    ...
    <>
      {
        isSmallScreen ?
          ...
          <>
            <Button variant="outline" disabled={!isHydrated} className="w-32 justify-between" onClick={toggleSidebar}>
              Filters
              <Settings2 />
            </Button>
            <div
              className={cn(
                "fixed right-0 h-full overflow-y-auto bg-white border-l w-[200px] sm:w-[300px] z-50",
