...
import DocumentCarousel from "../LinkedinPost/DocumentCarousel"

const DocumentPost = ({ data }: any) => {
  ...
  return (
    <>
      <div className="antialiased flex flex-col p-4 bg-white rounded-xl shadow border-2 border-zinc-100 h-fit">
          ...
          <div className="w-full">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-[#0f5315] bg-[#54e97952] px-2 py-1 rounded-full font-medium">Carousel</p>
              </div>
            </div>
        ...
        <div className="mt-4">
          <DocumentCarousel manifestUrl={data.content?.["com.linkedin.voyager.feed.render.DocumentComponent"].document?.manifestUrl} />
        </div>
