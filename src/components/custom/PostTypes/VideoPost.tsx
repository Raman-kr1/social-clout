  ...
  return (
    <>
      <div className="antialiased flex flex-col p-4 bg-white rounded-xl shadow border-2 border-zinc-100 h-fit">
          ...
          <div className="w-full">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-[#690550] bg-[#6d1e5946] px-2 py-1 rounded-full font-medium">Video</p>
              </div>
            </div>
        ...
        <div className="mt-3">
          {
            // data?.content?.["com.linkedin.voyager.feed.render.LinkedInVideoComponent"]?.
          }
        </div>
